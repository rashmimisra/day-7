...
const Card1 = (props) => {
    const {name,ingredients,instructions,prepTimeMinutes,cookTimeMinutes,servings,difficulty,cuisine, caloriesPerServing,image}=props;
  return (
    <>
    <div className=' container  d-flex  flex-wrap'>
    <div  className="card m-4 border border-dark border " style={{width:"35rem " , height:"67rem"}}>
    <img src={image} className="card-img-top "/>
    <div  className=" card-body">
      <div  className="card-text m-2 text-start">
        <div className='mt-2'> <b>Name:</b>{name}</div>
        <div className='mt-2  '><b>Ingridents:</b>{ingredients}</div>
